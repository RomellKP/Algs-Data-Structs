...
public class LinkedListTest {
    ...
    public static void printScore() {
        System.out.println();
        System.out.println("LinkedList: " + SCORING_TEST_RULE.getPoints() + " / " +
                SCORING_TEST_RULE.getTotal() + " points");
    ...
    public void addTest() {
        ...
        for (int it = 0; it < 1000; it++) {
            ...
            String[] test = new String[]{"One Piece", "Fullmetal Alchemist",
                    "Attack On Titan", "Tokyo Ghoul", "Haikyuu!!", "Mob Psycho", "Hunter x Hunter",
            ...
            for (int i = 0; i < 5; i++) {
                ...
                arr[idx] = test[toAdd];
                for (int j = 0; j < arr.length; j++) assertEquals(arr[j],
                        list.get(j)); // all elements should match
            }
            // add out of bounds
            for (int i = 0; i < 10; i++)
                assertFalse(list.add(list.size() + r.nextInt(list.size()),
                        test[r.nextInt(test.length)]));
        }
    }
    @Test
    ...
    public void indexOfTest() {
        ...
        for (int it = 0; it < 1000; it++) {
            ...
            for (int i = 0; i < 100; i++) {
                int idx = r.nextInt(test.length);
                assertEquals((int) map.getOrDefault(test[idx], -1),
                        list.indexOf(test[idx]));
                list.add(test[idx]);
                if (!map.containsKey(test[idx])) map.put(test[idx], list.size() -
                        1);
    ...
    public void sortTest() {
        ...
        for (int it = 0; it < 1000; it++) {
            ...
            list.sort();
            for (int i = 1; i < 250; i++)
                assertTrue(list.get(i).compareTo(list.get(i - 1)) >= 0); // ensurelist is sorted
        }
    }
    @Test
    ...
    public void equalToTest() {
        ...
        for (int it = 0; it < 1000; it++) {
            ...
            for (int i = 0; i < 250; i++) list.add(test[r.nextInt(test.length)]);
            for (int i = 0; i < 250; i++) if (list.get(i).equals("Haikyuu!!"))
                size++;
        ...
        for (int it = 0; it < 1000; it++) {
            ...
            for (int i = 0; i < 250; i++)
                assertEquals(list.get(i),
                        reversed.get(i)); // lists should match
        }
    }
    @Test
    @WorthPoints(points = 5)
    public void mergeTest() {
        ...
        for (int it = 0; it < 1000; it++) {
            ...
            String[] test1 = new String[]{"One Piece", "Fullmetal Alchemist",
                    "Attack On Titan", "Tokyo Ghoul", "Haikyuu!!", "Mob Psycho", "Hunter x Hunter"};
            ...
            Random r = new Random();
            HashMap<String, Integer> expected = new HashMap<>(), actual = new
                    HashMap<>(); // occurrences maps
            ...
            for (int i = 0; i < 500; i++) {
                actual.put(list1.get(i), actual.getOrDefault(list1.get(i), 0) + 1);
// comparison mp
                if (i != 0) assertTrue(list1.get(i).compareTo(list1.get(i - 1)) >= 0); // ensure merged list is sorted
            }
            for (String key : expected.keySet()) assertEquals(expected.get(key),
                    actual.get(key)); // maps should match
        }
    }
    @Test
    @WorthPoints(points = 5)
    public void rotateTest() {
        ...
        for (int it = 0; it < 1000; it++) {
            ...
            // create lists
            for (int i = 0; i < 250; i++) {
                if (list1.size() < 2) assertFalse(list1.rotate(2)); // can't rotatea list with less than two elements
                int idx = r.nextInt(test.length);
                list1.add(test[idx]);
                list2.add(test[idx]);
            }
    ...
    public void isSortedTest() {
        ...
        for (int it = 0; it < 50; it++) {
            ...
            String[] test = new String[]{"One Piece", "Fullmetal Alchemist",
                    "Attack On Titan", "Tokyo Ghoul", "Haikyuu!!", "Mob Psycho", "Hunter x Hunter",
                    "The Promised Neverland", "Solo Leveling", "The Breaker", "One Punch Man", " Dragon Ball Z", " JoJo's Bizarre Adventure", "Yuri!!! on ICE"};
            String[]sorted = new String[]{"Jojo's Bizarre Adventure", "Naruto",
                    "One Piece", "Solo Leveling", "The Breaker"};
            Random r = new Random();
            // add element
            for (int i = 0; i < 5; i++) {
                for (int j = 0; j < 10; j++) {
